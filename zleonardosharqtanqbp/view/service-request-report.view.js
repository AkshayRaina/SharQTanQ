sap.ui.jsview("ZLeonardo_SharqTanq_BP.view.service-request-report", {

	/** Specifies the Controller belonging to this View. 
	 * In the case that it is not implemented, or that "null" is returned, this View does not have a Controller.
	 * @memberOf ZLeonardo_SharqTanq_BP.view.service-request-report
	 */
	getControllerName: function() {
		return "ZLeonardo_SharqTanq_BP.controller.service-request-report";
	},
