sap.ui.define([
	...
	return Controller.extend("ZLeonardo_SharqTanq_BP.controller.reports", {

		/**
		 * Called when a controller is instantiated and its View controls (if available) are already created.
		 * Can be used to modify the View before it is displayed, to bind event handlers and do other one-time initialization.
		 * @memberOf ZLeonardo_SharqTanq_BP.view.reports
		 */
		//	onInit: function() {
		//
		//	},
		...
		openMachineReport: function() {
			...
			if (machineReport === undefined) {
				machineReport = new sap.ui.view({
					id: "machine-report",
					viewName: "ZLeonardo_SharqTanq_BP.view.machine-report",
		...
		openTDSReport: function() {
			...
			if (tdsReport === undefined) {
				tdsReport = new sap.ui.view({
					id: "tds-report",
					viewName: "ZLeonardo_SharqTanq_BP.view.tds-report",
					type: sap.ui.core.mvc.ViewType.JS,
					clearTarget: true,
					targetAggregation: "content"
				});
		...
		openCustomerReport:function() {
			...
			if (customerReport === undefined) {
				customerReport = new sap.ui.view({
					id: "customer-report",
					viewName: "ZLeonardo_SharqTanq_BP.view.customer-report",
					type: sap.ui.core.mvc.ViewType.JS,
					clearTarget: true,
					targetAggregation: "content"
				});
		...
		openWaterReport: function() {
			...
			if (waterReport === undefined) {
				waterReport = new sap.ui.view({
					id: "water-report",
					viewName: "ZLeonardo_SharqTanq_BP.view.water-report",
					type: sap.ui.core.mvc.ViewType.JS,
					clearTarget: true,
					targetAggregation: "content"
				});
		...
		openServiceRequestReport: function() {
			...
			if (serviceRequestReport === undefined) {
				serviceRequestReport = new sap.ui.view({
					...
					viewName: "ZLeonardo_SharqTanq_BP.view.service-request-report",
					type: sap.ui.core.mvc.ViewType.JS,
					clearTarget: true,
					targetAggregation: "content"
				});
		...
		openConnectedUsersReport: function() {
			...
			if (connectedUsersReport === undefined) {
				connectedUsersReport = new sap.ui.view({
					...
					viewName: "ZLeonardo_SharqTanq_BP.view.connected-users-report",
					type: sap.ui.core.mvc.ViewType.JS,
					clearTarget: true,
					targetAggregation: "content"
				});
		...
		openFirmwareReport: function() {
			...
			if (firmwareReport === undefined) {
				firmwareReport = new sap.ui.view({
					id: "firmware-report",
					viewName: "ZLeonardo_SharqTanq_BP.view.firmware-report",
					type: sap.ui.core.mvc.ViewType.JS,
					clearTarget: true,
					targetAggregation: "content"
				});
